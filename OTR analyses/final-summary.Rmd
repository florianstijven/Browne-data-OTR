...
ggsave(filename = "figures-manuscript/main-text/between-imputation-pm-estimates.png",
       device = "png",
       width = double_width,
...
```{r, results='hide', fig.show='hide'}
# Reproduce the previous figure, but only with CESD. This figure is used in the
# manuscript. In the paper, we do not discuss majority vote as aggregation
# method. So, this aggregation method has been removed from the figure as well.
pooled_inference_aggregated_rules_tbl %>%
...
```{r, results='hide', fig.show='hide'}
# Reproduce the previous figure. This figure is used in the manuscript.
pooled_inference_aggregated_rules_tbl %>%
  filter(imputation == "Per Arm",
         outcome == "cesd",
  ...
  guides(color = guide_legend(nrow = 2))
# ggsave(filename = "figures-manuscript/main-text/results-various-aggregation-methods.png",
#        device = "png",
#        width = single_width,
