...
/* Proc MI: For group = 1 */
ods graphics on;
proc mi data=final_updated_transformed1 out=final_MI_1_updated1 nimpute=&n_imputations seed=1;		
	where group = 1;
...
ods graphics on;
proc mi data=final_updated_transformed2 out=final_MI_1_updated2 nimpute=&n_imputations seed=1;		
	where group = 1;
	class sex disorder phealth;
	fcs nbiter=&n_burnin plots=trace reg() logistic() logistic(disorder/link=glogit);
	var sex disorder phealth age numchild
...
ods graphics on;
proc mi data=final_updated_transformed3 out=final_MI_1_updated3 nimpute=&n_imputations seed=1;		
	where group = 1;
	class sex disorder phealth;
	fcs nbiter=&n_burnin plots=trace reg() logistic() logistic(disorder/link=glogit);
	var sex disorder phealth age numchild
...
/* Proc MI: For group = 2 */
ods graphics on;
proc mi data=final_updated_transformed1 out=final_MI_2_updated1 nimpute=&n_imputations seed=1;		
	where group = 2;
	class sex disorder phealth;
	fcs nbiter=&n_burnin plots=trace reg() logistic() logistic(disorder/link=glogit);
	var sex disorder phealth age numchild
...
ods graphics on;
proc mi data=final_updated_transformed2 out=final_MI_2_updated2 nimpute=&n_imputations seed=1;		
	where group = 2;
	class sex disorder phealth;
	fcs nbiter=&n_burnin plots=trace reg() logistic() logistic(disorder/link=glogit);
	var sex disorder phealth age numchild
...
ods graphics on;
proc mi data=final_updated_transformed3 out=final_MI_2_updated3 nimpute=&n_imputations seed=1;		
	where group = 2;
	class sex disorder phealth;
	fcs nbiter=&n_burnin plots=trace reg() logistic() logistic(disorder/link=glogit);
	var sex disorder phealth age numchild
...
ods graphics on;
proc mi data=final_updated_transformed2 out=final_MI_3_updated2 nimpute=&n_imputations seed=1;		
	where group = 3;
	class sex disorder phealth;
	fcs nbiter=&n_burnin plots=trace reg() logistic() logistic(disorder/link=glogit);
	var sex disorder phealth age numchild
...
ods graphics on;
proc mi data=final_updated_transformed3 out=final_MI_3_updated3 nimpute=&n_imputations seed=1;		
	where group = 3;
	class sex disorder phealth;
	fcs nbiter=&n_burnin plots=trace reg() logistic() logistic(disorder/link=glogit);
	var sex disorder phealth age numchild
...
data final_MI_updated2;
	set final_MI_1_updated2 final_MI_2_updated2 final_MI_3_updated2;
run;

data final_MI_updated3;
	set final_MI_1_updated3 final_MI_2_updated3 final_MI_3_updated3;
run;

/* We transform the variables in the full imputed data set back to the original scale. */
data final_MI_updated1;
set final_MI_updated1;
...
proc sort data=final_MI_updated1;
	by _imputation_;
run;

proc sort data=final_MI_updated2;
	by _imputation_;
run;

proc sort data=final_MI_updated3;
	by _imputation_;
run;
...
data out.final_MI_updated1_per_arm;
set final_MI_updated1;
FORMAT _all_;
INFORMAT _all_;
run;

data out.final_MI_updated2_per_arm;
set final_MI_updated2;
FORMAT _all_;
INFORMAT _all_;
run;

data out.final_MI_updated3_per_arm;
set final_MI_updated3;
FORMAT _all_;
INFORMAT _all_;
run;
