...
data final_MI_incompatible;
set final_MI_incompatible;
...
proc sort data=final_MI_incompatible;
	by _imputation_;
run;
...
proc print data=final_MI_incompatible;
where id=1719;
run;
...
data out.final_MI_incompatible;
set final_MI_incompatible;
FORMAT _all_;
INFORMAT _all_;
run;
