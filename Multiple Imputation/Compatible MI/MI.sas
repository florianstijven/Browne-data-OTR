...
%let output_directory = C:/Users/u0157247/OneDrive - KU Leuven/Phd/Hulp Trung Dung/Browne-code/Multiple Imputation/Compatible MI;
...
/* Proc MI: For group = 3 */
ods graphics on;
proc mi data=final_transformed out=final_MI_3 nimpute=&n_imputations seed=3;		
	where group = 3;
	class sex disorder phealth;
	fcs nbiter=&n_burnin plots=trace reg() logistic() logistic(disorder/link=glogit);
	var sex disorder phealth age numchild
...
data final_MI;
	set final_MI_1 final_MI_2 final_MI_3;
run;
